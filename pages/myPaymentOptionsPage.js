...
class MyPaymentOptionsPage extends BasePage {
    ...
    get cardYearField() {return new DropDown($('(//div[contains(@class, "mat-expansion-panel-body")]//select)[2]'), "Card expirity year drop down")};
    get submitButton() {return new WebButton($('(//div[contains(@class, "mat-expansion-panel-body")]//button)[1]'), "Submit button")};
